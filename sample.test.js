...
const html = fs.readFileSync(path.resolve(__dirname, './App/index.html'), 'utf8');  //index
...
describe('Ensure pages served', () => {
    ...
    it('should get index page', async () => {
        ...
        const data = await fs.promises.readFile(path.join(__dirname, './App/index.html'), 'utf8');  //index
